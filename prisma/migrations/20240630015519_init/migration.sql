...
-- CreateIndex
CREATE UNIQUE INDEX "Bookmark_causeId_key" ON "Bookmark"("causeId");

-- CreateIndex
CREATE INDEX "Article_createdAt_isPublished_idx" ON "Article"("createdAt", "isPublished");

-- CreateIndex
CREATE UNIQUE INDEX "Certificate_documentKey_key" ON "Certificate"("documentKey");
...
-- AddForeignKey
ALTER TABLE "Bookmark" ADD CONSTRAINT "Bookmark_causeId_fkey" FOREIGN KEY ("causeId") REFERENCES "Cause"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Article" ADD CONSTRAINT "Article_categoryId_fkey" FOREIGN KEY ("categoryId") REFERENCES "Category"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Certificate" ADD CONSTRAINT "Certificate_documentKey_fkey" FOREIGN KEY ("documentKey") REFERENCES "Media"("key") ON DELETE RESTRICT ON UPDATE CASCADE;
