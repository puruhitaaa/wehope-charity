...
import { ny, formatBytes } from "@/lib/utils";
...
>(({ children, className, variant, ...props }, ref) => {
  ...
  return (
    <div
      ...
      className={ny(fileUploaderInputVariants({ variant, className }))}
      {...props}
      {...getRootProps()}
    >
...
>(({ file, index, progress, className, ...props }, ref) => {
  ...
  return (
    <div
      ref={ref}
      className={ny("relative flex items-center space-x-4", className)}
      {...props}
    >
