          ...
          <div className="container px-4 md:px-6">
            <div className="grid gap-6 lg:grid-cols-[1fr_400px] lg:gap-12 xl:grid-cols-[1fr_600px]">
              ...
              <Image
                ...
                height={500}
                alt="Hero"
                className="mx-auto aspect-video overflow-hidden rounded-xl object-cover object-bottom sm:w-full"
              />
            </div>
          </div>
        </section>
            ...
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="max-w-[900px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  ...
                  contribution, no matter how big or small, can make a
                  significant difference in shaping a brighter future for all.
                </p>
              </div>
            </div>
                ...
                <ul className="grid gap-6">
                  ...
                  <li className="bg-secondary border border-primary p-4 rounded-xl hover:bg-primary group transition-colors ease-out">
                    <Link className="grid gap-1" href="#">
                      ...
                      <p className="text-muted-foreground group-hover:text-primary-foreground">
                        Talk about recent events and possibly raise a new
                        concern that the community can help directly
                      </p>
                    </Link>
                  </li>
                </ul>
